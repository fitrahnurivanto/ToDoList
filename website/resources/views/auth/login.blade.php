    ...
    <div class="max-w-md w-full space-y-8">
        <div class="bg-white rounded-3xl shadow-2xl p-10">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-4 text-2xl font-extrabold text-gray-900 tracking-tight">Masuk ke ToDoList Kamu</h2>
                <p class="mt-2 text-sm text-gray-500">Kelola tugas harianmu dengan mudah dan cepat.</p>
            </div>
            ...
            <form class="mt-8 space-y-6" action="{{ route('login.post') }}" method="POST" autocomplete="off">
                ...
                <div class="text-center mt-4">
                    <p class="text-sm text-gray-600">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold text-emerald-600 hover:text-emerald-500 transition">Daftar sekarang</a>
                    </p>
                </div>
            </form>
        </div>
