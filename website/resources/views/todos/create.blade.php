...
<body class="bg-gradient-to-br from-emerald-50 to-emerald-100 min-h-screen font-poppins">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Isi detail tugas yang ingin kamu tambahkan</p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden animate-fade-in">
            <div class="bg-emerald-500 p-8 text-white rounded-t-3xl">
                <h2 class="text-2xl font-bold mb-2">
                    @if(isset($duplicateTask))
                        Duplikasi Detail Tugas
                    @else
                        Buat Tugas Baru
                    @endif
                </h2>
                <p class="opacity-90">Isi form di bawah untuk menambah tugas ke daftar ToDoList kamu.</p>
            </div>
            <div class="p-8">
                <form action="{{ route('todos.store') }}" method="POST" class="space-y-8" id="createForm">
                    ...
                    <div>
                        ...
                        <textarea id="description"
                                  ...
                                  placeholder="Deskripsi tugas (opsional)" maxlength="1000">{{ old('description', isset($duplicateTask) ? $duplicateTask->description : '') }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600 flex items-center bg-red-50 p-3 rounded-xl">
                                <i class="fas fa-exclamation-circle mr-2"></i>{{ $message }}
                            </p>
        ...
        <div class="mt-10 text-center">
            <div class="bg-white rounded-2xl shadow p-6 max-w-xl mx-auto border-t-4 border-emerald-500">
                ...
                <p class="text-gray-700 italic text-lg mb-3">
                    "Langkah kecil hari ini lebih baik daripada rencana besar yang tidak pernah dijalankan."
                </p>
    ...
    <!-- Animasi Fade-in & Custom Scrollbar & Dark Mode -->
    <style>
        @keyframes fade-in {
